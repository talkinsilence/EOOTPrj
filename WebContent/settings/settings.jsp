                ...
                <div id="accordion">
                    ...
                    <div>
						<c:if test="${not empty famInvsMe}">
							<c:forEach var="fInvsMe" items="${famInvsMe}" varStatus="idx">
		                        <div id="invited">
		                            <ul>
		                                <li class="link">
		                                    ...
		                                    <input type="button" class="btn-invited-accept" value="수락" />
		                                    <input type="button" class="btn-invited-reject btn-cancel" value="거절" onclick="famInvMeReject('${fInvsMe.famcode}')"/>
		                                </li>
		                            </ul>
		                        </div>
	                        </c:forEach>
                                ...
                                <fieldset id="myhome-member-mng-inv-view">
									...
									<c:if test="${not empty finvs}">
										<c:forEach var="finvs" items="${finvs}">
		                                    <ul>
		                                        <li class="myhome-member-mng-uid">${finvs.askmid}</li>
                                    	...
                                    	<c:if test="${not empty neis}">
                                    		<c:forEach var="neis" items="${neis}">
	                                    		<ul>
		                                            ...
		                                            <li class="eoot-with-get-name link">
		                                            	<a a target="_blank" href="../main/main_e.jsp?fc=${neis.famcode}">${neis.name}</a>
		                                            </li>
		                                            <li class="eoot-with-get-msg">
